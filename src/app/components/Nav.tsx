...
export const Nav = () => {
  return (
    <>
      <div className="fixed bottom-0 md:left-[25px] flex  flex-col items-center hidden md:flex">
        {/* github */}
        <Link href="https://github.com/mramazzini" target="_blank">
          <svg
        ...
        <div className="line w-[2px] h-[50px] bg-white/50 m-2" />
        {/* email */}
        <Link href="mailto:mramazzini123@gmail.com">
          <svg
            className="w-10 h-10 opacity-50 hover:opacity-100"
            viewBox="0 0 24 24"
            fill="#ffffff"
        ...
        <div className="line w-[2px] h-[50px] bg-white/50 m-2" />
        <Link
          href="https://www.linkedin.com/in/matteo-ramazzini"
          target="_blank"
        >
          <svg
            className="w-10 h-10 opacity-50 hover:opacity-100"
        ...
        <div className="line w-[2px] h-[50px] bg-white/50 m-2" />
        <Link
          href="https://drive.google.com/file/d/1TsAVw6lPuoclyKHi8pZoanUarLQcXCP1/view?usp=sharing"
          target="_blank"
        >
          <Image
        ...
        <div className="line w-[2px] h-[50px] bg-white/50 mt-2" />
      </div>
      {/* mobile */}
      <div className="absolute top-0 left-50 flex  flex-row items-center md:hidden flex p-4">
        {/* github */}
        <Link href="https://github.com/mramazzini" target="_blank">
          <svg
            className="w-10 h-10 opacity-50 hover:opacity-100"
        ...
        <div className="line h-[2px] w-[25px] bg-white/50 m-2" />
        {/* email */}
        <Link href="mailto:mramazzini123@gmail.com">
          <svg
            className="w-10 h-10 opacity-50 hover:opacity-100"
